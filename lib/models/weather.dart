...
class DailyWeather {
  ...
  static DailyWeather fromJson(Map<String, dynamic> json) {
    ...
    // I guess the API changed or I looked at the wrong docs
    // It seems 'temp' is not there, but 'main' might have it
    var tempMin = 0.0;
    var tempMax = 0.0;
    
    if (json['temp'] != null) {
      // This is for OneCall API I think
      tempMin = (json['temp']['min'] as num).toDouble();
      tempMax = (json['temp']['max'] as num).toDouble();
    } else if (json['main'] != null) {
      // This is for Standard Forecast API
